export default {
  ...
  input: ({ props }) => ({
    class: [
      ...
      // Font
      'font-recoleta-regular leading-none',
  ...
  header: {
    class: [
      // Font
      'font-recoleta-regular font-normal text-base leading-5',
  ...
  monthTitle: {
    class: [
      // Font
      'font-recoleta-regular font-normal text-lg leading-5',
  ...
  weekheader: {
    class: ['leading-5', 'text-green-tertiary', 'opacity-60 cursor-default'],
  },
  weeknumber: {
    class: ['text-green-tertiary', 'opacity-60 cursor-default'],
  },
  weekday: {
    class: [
  ...
  daylabel: ({ context }) => ({
    class: [
      ...
      {
        'opacity-40 cursor-default border-transparent text-gray-tertiary': context.disabled,
        'cursor-pointer': !context.disabled,
      },
    ],
  }),
