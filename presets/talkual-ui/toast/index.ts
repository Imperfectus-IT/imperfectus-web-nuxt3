export default {
  ...
  container: ({ props }) => ({
    class: [
      ...
      // Colors
      {
        'bg-blue-100/80': props.message.severity == 'info',
        'bg-green-quaternary/80': props.message.severity == 'success',
        'bg-orange-100/80': props.message.severity == 'warn',
        'bg-red-primary/80': props.message.severity == 'error',
      },
      {
        'border-blue-500 dark:border-blue-400': props.message.severity == 'info',
        'border-green-tertiary': props.message.severity == 'success',
      ...
      },
      {
        ...
        'text-green-tertiary': props.message.severity == 'success',
