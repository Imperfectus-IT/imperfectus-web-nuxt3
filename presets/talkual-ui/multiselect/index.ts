        ...
        box: ({ props, context }) => ({
            class: [
                ...
                // States
                {
                    ...
                    'peer-hover:bg-transparent peer-hover:border-green-tertiary': !props.disabled && context.checked,
                    'peer-focus-visible:border-green-tertiary peer-focus-visible:ring-2 peer-focus-visible:ring-0': !props.disabled,
                    'cursor-default opacity-60': props.disabled
                },
