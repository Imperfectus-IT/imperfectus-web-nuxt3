    ...
    root: ({props, context, parent}) => ({
        class: [
            ...
            // States
            {
                ...
                'focus:outline-none focus:outline-offset-0 focus:ring-shadow focus:ring-none ring-offset-shadow:none focus:shadow-none ring-offset-transparent focus: bg-transparente': !context.disabled,
