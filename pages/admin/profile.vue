...
<template>
  <section class="w-full 2xl:px-64">
    ...
    <div class="grid grid-cols-1 gap-5 lg:gap-0 lg:flex lg:flex-col-2 lg:mt-10">
      <ImageProfile />
      <PersonalData v-if="!isModifyingProfile" @on-modify-data="handleToggleModifyProfile" :personal-data="personalData" />
      <PersonalDataForm v-if="isModifyingProfile" @on-modify-data="handleToggleModifyProfile" :personal-data="personalData" />
    </div>
    <div class="w-full">
