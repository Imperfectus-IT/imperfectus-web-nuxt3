<template>
  <div class="min-w-[1000px]">
    ...
    >
      ...
      <p v-if="order.status === 'pending'" class="bg-orange-primary w-1/2 px-2 py-2 rounded-lg ">
      ...
      <div class="flex flex-row justify-between flex-wrap -mt-6 ">
        ...
        >
          <div class="flex flex-col">
            ...
            />
            <OrderItemRating :ratings="orderItem.review"/>
        ...
        <div v-else class="flex flex-row justify-between w-full items-center mt-7">
