<template>
  <div
    class="font-solina-extended-book m-6 lg:flex lg:flex-row lg:justify-center lg:gap-20"
  >
    <div class="flex flex-row lg:flex-col">
      <NuxtImg
        :key="`${imageWidth}-${imageHeight}`"
        src="images/admin/my-acount/mi-cuenta-1.webp"
        alt="mi-cuenta-1"
        format="webp"
        loading="lazy"
        :width="imageWidth"
    ...
    <div class="flex flex-row lg:flex-col mt-10 lg:mt-0">
      <NuxtImg
        :key="imageWidth"
        src="images/admin/my-acount/mi-cuenta-2.webp"
        alt="mi-cuenta-1"
        format="webp"
        loading="lazy"
        :width="imageWidth"
