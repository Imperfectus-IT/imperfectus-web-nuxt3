...
<template>
  <HeaderDefault
    class="overflow-hidden bg-center relative bg-cover flex items-center justify-center mt-[50px] md:mt-0 lg:h-[500px] before:content-[''] before:block before:bg-black before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-[rgba(0,0,0,.3)]"
    :style="{
