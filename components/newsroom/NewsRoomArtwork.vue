...
<template>
  <DarkNewsRoomSection class="lg:hidden" :title="$t('newsroom.multimedia.title')">
    <div
    ...
    >
      ...
      <div class="flex justify-center mt-8 relative">
        <span class="mdi mdi-chevron-down absolute bottom-0 right-12 text-[2rem]" @click="toggle"/>
        <NuxtImg
            :src="item.cover"
            :alt="item.altCover"
            width="270"
    ...
    <OverlayPanel ref="op" class="w-full h-[250px] bg-green-quaternary mt-[50px]">
  ...
  <DarkNewsRoomSection class="hidden lg:block" :title="$t('newsroom.multimedia.title')">
