    ...
    root: ({ props }) => ({
        class: [
            ...
            // Primary Button
            {
                ...
                'bg-green-primary': !props.severity && !props.text && !props.outlined && !props.plain,
                'border-none': props.severity === null && !props.text && !props.outlined && !props.plain
            },
            // Primary Text Button
