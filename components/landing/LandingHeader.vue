<template>
  <video
    class="border-2 border-black w-full mt-14 lg:h-[65vh] lg:object-cover lg:rounded-xl lg:w-auto lg:mx-6 lg:mt-10"
    controls
    autoplay
    muted
    loop
  ...
  />
   <div class="-mt-9 lg:flex lg:flex-row lg:justify-between lg:mt-16 lg:relative lg:right-20">
    <div class="lg:flex lg:flex-col">
      ...
      <p class="text-center mt-8 lg:text-left lg:ml-52">
