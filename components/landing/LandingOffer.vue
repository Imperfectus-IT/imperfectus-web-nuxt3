<template>
    ...
    >
      <div class="flex items-center">
        <div
          ...
          class="bg-green-primary w-4 h-4 rounded-xl ml-4"
        />
      ...
      <p v-if="currentOption === $t(option.title)" class="ml-4">
  ...
  <div
    class="bg-green-tertiary text-green-quaternary text-[35px] p-8 leading-[43px]"
  >
    <p class="inline">
