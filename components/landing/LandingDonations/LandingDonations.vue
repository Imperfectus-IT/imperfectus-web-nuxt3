  ...
  <div>
    <div class="mt-4">
      <div class="lg:grid lg:grid-cols-2 ">
        <h2 class="font-recoleta-regular text-[50px] ml-8 font-semibold lg:col-start-2 lg:row-start-1 lg:mt-6">
        ...
        />
        <p 
        class="mx-10 my-6 text-[17px] leading-7 
          lg:col-start-2 lg:col-span-2 lg:text-[26px] lg:row-start-1 lg:mt-40
        ">
          {{ $t('homeDonations.description') }}
        </p>
      </div>
      <LandingDonationsCarousel
        v-if="!displayDesktop"
        :data="donations"
      />
      <LandingDonationsCards
        v-if="displayDesktop"
        :data="donations"
      />
    </div>
...
const donations = ref<CarouselSlideObject[]>([
  {
    index: 1,
    title: t('homeDonations.foundation1.title'),
    description: t('homeDonations.foundation1.description'),
